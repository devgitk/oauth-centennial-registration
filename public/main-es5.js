(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.registeroAuthUser = function (user) {
                    var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
                    headers.append('Content-Type', 'application/json');
                    return this.http.post('users/registeroAuth', user, { headers: headers }).map(function (res) { return res.json(); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(authService, router, flashMessage, document) {
                    this.authService = authService;
                    this.router = router;
                ...
                LoginComponent.prototype.signIn = function () {
                    var _this = this;
                    myMSALObj.loginPopup(requestObj).then(function () {
                        //Successful login
                        //this.showWelcomeMessage();
                        ...
                        _this.authService.registeroAuthUser(user).subscribe(function (data) {
                            console.log(data);
                            if (data.success) {
                                console.log('success');
                                _this.flashMessage.show('You are now authenticated! ', { cssClass: 'alert-success', timeout: 3000 });
                                var navigationExtras = { state: { micName: micName } };
                ...
                LoginComponent.prototype.showWelcomeMessage = function () {
                    var divWelcome = document.getElementById('WelcomeMessage');
                    var htmlStr = "Welcome " + myMSALObj.getAccount().userName + " to Microsoft Graph API";
                ...
                LoginComponent.prototype.acquireTokenPopupAndCallMSGraph = function () {
                    var _this = this;
                    //Always start with acquireTokenSilent to obtain a token in the signed in user from cache
                    myMSALObj.acquireTokenSilent(requestObj).then(function (tokenResponse) {
                        _this.callMSGraph(graphConfig.graphMeEndpoint, tokenResponse.accessToken, _this.graphAPICallback);
                    }).catch(function (error) {
                        console.log(error);
                        // Upon acquireTokenSilent failure (due to consent or interaction or login required ONLY)
                        // Call acquireTokenPopup(popup window) 
                        if (_this.requiresInteraction(error.errorCode)) {
                ...
                LoginComponent.prototype.acquireTokenRedirectAndCallMSGraph = function () {
                    var _this = this;
                    //Always start with acquireTokenSilent to obtain a token in the signed in user from cache
                    myMSALObj.acquireTokenSilent(requestObj).then(function (tokenResponse) {
                        _this.callMSGraph(_this.graphConfig.graphMeEndpoint, tokenResponse.accessToken, _this.graphAPICallback);
                    }).catch(function (error) {
                        console.log(error);
                        // Upon acquireTokenSilent failure (due to consent or interaction or login required ONLY)
                ...
                LoginComponent.prototype.requiresInteraction = function (errorCode) {
                ...
                LoginComponent.prototype.callMSGraph = function (theUrl, accessToken, callback) {
                ...
                LoginComponent.prototype.graphAPICallback = function (data) {
                    //document.getElementById("json").innerHTML = JSON.stringify(data, null, 2); 
                };
                LoginComponent.prototype.authRedirectCallBack = function (error, response) {
                    if (error) {
                        console.log(error);
                    }
                    else {
                ...
                LoginComponent.prototype.onLoginSubmit = function () {
                    ...
                    this.authService.authenticateUser(user).subscribe(function (data) {
                        if (data.success) {
                            ...
                            _this.router.navigate(['dashboard', data.user]);
                        }
                        else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function () {
                function RegisterComponent(authService, router, flashMessage, document) {
                    this.authService = authService;
                    this.router = router;
                    this.flashMessage = flashMessage;
                }
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Users\sridh\Documents\College_Work\Studies\Semester 4\COMP 306 - API and Cloud computing\Lab\Project\forPartB\final\oauth-centennial-registration\reg-app\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
